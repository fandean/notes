...
| PDF            | Icecream PDF Editor免费、Master PDF Editor、Foxit Reader 、AdobeAcrobatXIPropjbd、SumatraPDF |
| 复制软件       | ExtremeCopy Pro                                              |
| 卸载           | **geek**                                                     |
| 散列值检测     | Hasher （7z就可以满足）                                      |
| 播放器         | PotPlayer Mini、MPV                                          |
...
| gvim           | vim 图形版                                                   |
| 文件同步       | BitTorrent Sync、FreeFileSync                                |
| 翻译           | Mdict                                                        |
...
| 图片编辑       | GIMP、inkscape                                               |
| 图床           | PicGO                                                        |
| 文件管理器     | Free Commander                                               |
| 记事本         | Notepad2、（另外Windows有计划加强自带记事本）                |
| 任务清单工具   | To Do，Notion，Taskade                                       |
| 图片浏览       | IrfanView                                                    |
| 电子书阅读     | **Calibre**、微信读书（通过公众号、小程序）、越飞阅读、FBReader即将推出 |
